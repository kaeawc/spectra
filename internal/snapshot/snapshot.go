...
func snapshotAppPaths(opts Options) []string {
	...
	// App auto-discovery is macOS-only: there is no .app model to scan
	// for elsewhere. Explicit AppPaths are still honored above (and the
	// detect engine gates them per OS).
